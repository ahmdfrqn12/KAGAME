...
ki = LINE("EFDTztYUFOgViVqLgT96.kZ+Nb526H9HKQ1iM7+v7jG.ctRr8S4J7TrSIYAXVXXIKJQVC3wJ7rwhKbF18iRC+i8=")
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if wait["detectMention"] == True: md+="║͜͡☆➣ Bobok ✔️\n"
                                else: md+="║͜͡☆➣ Bobok ❌\n"
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendMessage(msg.to, "see you papay.. "+str(G.name))
