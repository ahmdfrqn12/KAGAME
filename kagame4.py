...
wait = {
    ...
    "comment":"Like like & like by ʙᴏᴛs кᴀɢᴀмᴇ",
...
def help():
    ...
    helpMessage = "⚫MËÑÛ ĶÄĞÅMĔ⚫\n" + \
                  ...
                  "⚡" + key + "Kagame\n" + \
                  "⚡" + key + "Tagall/Eh\n" + \
                  "⚡" + key + "Kagame in/Tikungan in\n" + \
                  "⚡" + key + "Kagame bye/Tikungan bye\n" + \
                  "⚡" + key + "Pulang\n" + \
                  "⚡" + key + "Leave「Namagrup」\n" + \
                  "⚡" + key + "Ginfo\n" + \
                  "⚡" + key + "Open\n" + \
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           #rnd = ["woy dakocan tag gue lagi, gue kutuk lu jadi setrikaan"]
                           #p = random.choice(rnd)
                           #lang = 'id'
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"ʙᴏᴛs кᴀɢᴀмᴇ") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "KAGAME SUDAH SIAP TEMPUR KAPTEN.    \nMENUNGGU KOMANDO")
                               #cl.sendMessage(msg.to, "KAGAME SUDAH SIAP TEMPUR KAPTEN.    \nMENUNGGU KOMANDO")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               try:
                                   ...
                                   cl.sendText(msg.to,"Mantan Berhasil Dibersihkan...")
                               except:
                                   pass
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "⚫Kagame Fams Grup Info\n\n⚫Nama Group : {}".format(G.name)+ "\n⚫ID Group : {}".format(G.id)+ "\n⚫Pembuat : {}".format(G.creator.displayName)+ "\n⚫Waktu Dibuat : {}".format(str(timeCreated))+ "\n⚫Jumlah Member : {}".format(str(len(G.members)))+ "\n⚫Jumlah Pending : {}".format(gPending)+ "\n⚫Group Qr : {}".format(gQr)+ "\n⚫Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                        elif cmd == "tagall" or text.lower() == 'eh':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"⚫Kagame  bot\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"⚡кᴀɢᴀмᴇ  admin⚡\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」 Kagame" %(str(len(owner)+len(admin)+len(staff))))
                        ...
                        elif cmd == "anti baper stay":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ginfo = cl.getGroup(msg.to)
                                    cl.inviteIntoGroup(msg.to, [Zmid])
                                    cl.sendMessage(msg.to,"Grup 「"+str(ginfo.name)+"」 Aman Dari Gangguan Puskun")
                                except:
                                    pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendText(msg.to, "Aim pulang dulu ya fams "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendText(msg.to, "Izin Pamit, Bye fams "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "⚫кᴀɢᴀмᴇ speed яёspon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "Nikung diaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "Nikung dinonaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
                                  cl.sendMessage(msg.to, "Sudak tidak aktif bos")
...
#===========Hiburan============#
                          ...
                          if msg._from in admin:
                           ...
                           if msg._from in admin:
                               ...
                               with requests.session() as web:
                                   web.headers["User-Agent"] = random.choice(settings["userAgent"])
                                   r = web.get("http://api.ntcorp.us/joox/search?q={}".format(urllib.parse.urlencode(params)))
                                   try:
                           ...
                           if msg._from in admin:
                              ...
                              with requests.session() as web:
                                  web.headers["User-Agent"] = random.choice(settings["userAgent"])
                                  r = web.get("https://farzain.xyz/api/premium/joox.php?apikey=al11241519&id={}".format(urllib.parse.urlencode(params)))
                                  try:
                                      data = json.loads(r.text)
                                      for song in data:
                                          ret_ = "╔══[ Music ]"
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"⚫Kagame Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"⚫Kagame Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              cl.sendMessage(msg.to,"Sukses Kami Ampuni Kalian " +mc)
#===========COMMAND SET============#
